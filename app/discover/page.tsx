...
export default function DiscoverPage() {
    ...
    <div className=" bg-[#FFFFFF] overflow-hidden">
      ...
      <header className="sticky top-0 z-40 flex items-center justify-between px-5 py-4 backdrop-blur-lg  bg-transparent ">
        ...
        <a
          ...
          target="_blank"
          className="rounded-full bg-[#0000000f] font-500 px-4 py-2 text-sm font-medium text-foreground hover:bg-muted/80 transition"
        >
  ...
  shadow-sm"
        ...
        <div className="flex items-center justify-center gap-2 mt-4">
          ...
          <p className="text-sm text-gray-600">215 campaigns live</p>
        </div>
      </section>
