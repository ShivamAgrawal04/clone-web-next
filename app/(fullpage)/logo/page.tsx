        ...
        <div className="min-h-screen bg-page-bg text-text-primary selection:bg-blue-600 selection:text-text-primary">
            ...
            <section className="pt-[180px] pb-24 px-4 sm:px-8 flex flex-col items-center justify-center text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
                    ...
                    <button className="rounded-full bg-transparent border border-page-border hover:bg-text-primary/5 text-text-primary flex items-center justify-center gap-3 text-lg font-bold px-10 py-5 transition-colors uppercase tracking-wide">
                ...
                <div className="w-full px-4 sm:px-8 md:px-12 lg:px-16">
                    ...
                    <div className="mb-16">
                        <div className="flex flex-wrap items-center gap-4 mb-4">
                            ...
                            <h2 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold tracking-tight text-[#111]">Logo Content</h2>
                        </div>
                        <h3 className="text-xl md:text-2xl font-bold text-[#111]/80">Bennybucks Powers Logo Content</h3>
                    </div>
