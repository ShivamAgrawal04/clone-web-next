    ...
    return (
        <header className="sticky top-0 z-50 bg-[#0a0a0a] border-b border-white/10">
            <div className="h-[3px] bg-[#1a1a1a]">
                <div className="h-full bg-[#e5383b] transition-all duration-150" style={{ width: `${progress}%` }} />
            </div>
            <div className="mx-auto flex max-w-[1480px] items-center justify-between px-8 py-4">
                ...
                <div className="flex items-center gap-4">
                    <a href="#" className="text-base text-white/70 hover:text-white font-medium px-2 transition-colors">
                        Join Our Community
                    </a>
                ...
                <div className="mx-auto max-w-[1480px] px-8 py-16 md:py-20 flex flex-col md:flex-row items-center gap-10 md:gap-16">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-[3.25rem] font-extrabold leading-[1.12] text-white">
                            What is a whop?<br />A complete guide to whops
                        </h1>
                        <div className="mt-7 flex flex-wrap items-center gap-4 text-base text-white/60">
                            <div className="flex items-center gap-2.5">
                                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center text-sm font-black text-white">E</div>
                                <span>By <span className="text-white/90 font-semibold">East</span></span>
                                <span className="text-blue-400 text-lg">✔</span>
                            </div>
                            <span className="text-white/30 text-xl">|</span>
                            <div className="flex items-center gap-2.5">
                                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-purple-400 to-blue-500 flex items-center justify-center text-sm font-black text-white">K</div>
                                <span>Reviewed by <span className="text-[#3b6ff5] font-semibold hover:underline cursor-pointer">Keisha Singleton</span></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-[520px] xl:w-[580px] flex-shrink-0">
                        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#1a1a2e] to-[#16213e] border border-white/10 aspect-[4/3] shadow-2xl shadow-black/60">
                            ...
                            <div className="relative z-10 w-full h-full flex">
                                {/* Mock sidebar */}
                                <div className="w-18 bg-[#0a0a0f]/80 flex flex-col items-center py-5 gap-5 border-r border-white/10" style={{ width: "72px" }}>
                                    ...
                                    <div className="w-10 h-10 rounded-xl bg-[#3b6ff5]/60 flex items-center justify-center mt-1">
                                        <svg width="15" height="15" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>
                                    </div>
                                </div>
                                {/* Mock content */}
                                <div className="flex-1 p-4 flex flex-col gap-3">
                                    <div className="text-xs text-white/40 font-semibold tracking-wide">$500 IN 7 DAYS ▾</div>
                                    <div className="bg-[#1a1a2e]/60 rounded-xl p-3 text-[11px] text-white/70 border border-white/5">
                                        <div className="font-bold text-white/40 mb-2 text-[9px] tracking-widest">ADMIN AREA</div>
                                        <div className="flex items-center gap-2 py-1.5 border-b border-white/10">
                                            <div className="w-2.5 h-2.5 rounded-sm bg-white/20" /><span>Checklist</span>
                                        </div>
                                        <div className="flex items-center gap-2 py-1.5">
                                            <div className="w-2.5 h-2.5 rounded-sm bg-white/20" /><span>Dashboard</span>
                                        </div>
                                    </div>
                                    <div className="flex-1 rounded-xl overflow-hidden bg-gradient-to-b from-purple-800/50 via-pink-800/30 to-indigo-900/60 flex items-end p-3 border border-white/5">
                                        <div className="text-[10px] text-white/40 font-medium">Whop App Preview</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex border-b border-white/10">
                            {(["listen", "contents", "summary"] as const).map((tab) => (
                                <button
                                    ...
                                    className={`flex-1 py-3.5 text-sm font-semibold capitalize transition-colors flex items-center justify-center gap-2 ${activeTab === tab ? "text-white border-b-2 border-white" : "text-white/40 hover:text-white/70"
                                        }`}
                                >
                                    {tab === "listen" && <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /><line x1="12" y1="19" x2="12" y2="23" /><line x1="8" y1="23" x2="16" y2="23" /></svg>}
                                    {tab === "contents" && <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><line x1="8" y1="6" x2="21" y2="6" /><line x1="8" y1="12" x2="21" y2="12" /><line x1="8" y1="18" x2="21" y2="18" /><line x1="3" y1="6" x2="3.01" y2="6" /><line x1="3" y1="12" x2="3.01" y2="12" /><line x1="3" y1="18" x2="3.01" y2="18" /></svg>}
                                    {tab === "summary" && <svg width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>}
                                    {tab}
                                </button>
                            ))}
                        </div>
                            ...
                            {activeTab === "listen" && (
                                <div className="py-6 text-center">
                                    <div className="mx-auto mb-4 h-14 w-14 rounded-full bg-white/10 flex items-center justify-center">
                                        <svg width="24" height="24" fill="none" stroke="white" strokeWidth="2" viewBox="0 0 24 24"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /></svg>
                                    </div>
                                    <p className="text-base text-white/60 mb-4">Listen to this article</p>
                                    <button className="rounded-xl bg-[#3b6ff5] text-white text-sm font-semibold px-5 py-2.5">Play audio</button>
                                </div>
                            )}
                            {activeTab === "summary" && (
                                <div className="space-y-3 py-2 text-[15px] text-white/60 leading-relaxed">
                                    <p>A whop is a customizable online business space for courses, memberships, and communities.</p>
                                    <p>Whop apps are modular building blocks that let creators add features easily.</p>
                                    <p>Built-in marketplace helps creators get discovered by millions.</p>
                                </div>
                            )}
                        </div>
                    </div>
                        ...
                        <div className="relative h-56 bg-gradient-to-br from-[#0d1117] via-[#1a1f2e] to-[#0d1117] overflow-hidden">
                            <div className="absolute inset-0 p-4">
                                <div className="w-full h-full bg-white/5 rounded-xl border border-white/10 p-3 overflow-hidden">
                                    <div className="text-[9px] text-white/40 mb-1.5 font-medium">Today</div>
                                    ...
                                    <div className="text-[9px] text-white/40 mt-1">$10,000,000.00</div>
                                </div>
                            </div>
                ...
                <main ref={articleRef} className="min-w-0 flex-1">
                    ...
                    <div id="intro" className="scroll-mt-24 mb-14">
                        ...
                        <div className="my-8 rounded-2xl border border-white/10 bg-[#1a1a1a] p-7">
                            <p className="text-base font-bold text-white mb-4">Key takeaways</p>
                            <ul className="space-y-4">
                                {[
                                    ...
                                    <li key={point} className="flex items-start gap-3 text-base text-white/70 leading-relaxed">
                                        <span className="mt-2 h-2 w-2 rounded-full bg-[#3b6ff5] flex-shrink-0" />
                                        <span dangerouslySetInnerHTML={{ __html: point.replace(/(courses|coaching|memberships|monetizable offer|chat|forums|built-in marketplace|millions)/g, '<span class="text-[#3b6ff5] font-medium">$1</span>') }} />
                                    </li>
                                ))}
                            </ul>
                        </div>
                        ...
                        <p className="text-lg text-white/70 leading-relaxed">
                            The internet has made it possible for <em className="text-white not-italic font-semibold">anyone</em> to turn an idea into a business. Whether you want
                            to teach, coach, build a community, or sell a service, all you need is the right place to bring it to life.
                        </p>
                        <p className="mt-5 text-lg text-white/70 leading-relaxed">
                            That&apos;s where <span className="text-[#3b6ff5] font-semibold">Whop comes in.</span>
                        </p>
                        <p className="mt-5 text-lg text-white/70 leading-relaxed">
                    ...
                    <div id="what-is" className="scroll-mt-24 mb-14">
                        <h2 className="text-3xl font-extrabold text-white mb-7">What is a whop?</h2>
                        ...
                        <div className="mb-8 rounded-3xl overflow-hidden border border-white/10 aspect-[16/8] bg-gradient-to-br from-purple-900 via-pink-900/60 to-indigo-900 flex items-center justify-center relative">
                            ...
                            <div className="relative z-10 flex w-full h-full">
                                <div className="bg-black/50 flex flex-col items-center py-6 gap-5 border-r border-white/10" style={{ width: "76px" }}>
                                    ...
                                    {[0, 1, 2, 3].map(i => (
                                        <div key={i} className="w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center">
                                ...
                                <div className="flex-1 p-6 flex flex-col justify-end">
                                    <div className="rounded-2xl bg-black/50 backdrop-blur-md border border-white/10 p-4 max-w-[260px]">
                                        <div className="flex items-center gap-2.5 mb-3">
                                            ...
                                            <span className="text-sm text-white/80 font-semibold">Whop</span>
                                        </div>
                                        <p className="text-sm text-white/50">Your customizable business space</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <p className="text-lg text-white/70 leading-relaxed mb-5">
                            A whop is your customizable online space built to fit whatever business or community you want to create.
                        </p>
                        <p className="text-lg text-white/70 leading-relaxed mb-5">
                    ...
                    <div id="examples" className="scroll-mt-24 mb-14">
                        <h2 className="text-3xl font-extrabold text-white mb-7">Real examples of whops</h2>

                        <div className="mb-8">
                            <h3 className="text-xl font-bold text-white mb-5">
                                Data Engineer Academy: <span className="text-white/60 font-semibold">$3,000/month</span>
                            </h3>
                            <div className="rounded-3xl border border-white/10 bg-[#1a1a1a] overflow-hidden">
                                <div className="flex items-center gap-3 px-6 pt-6 pb-3">
                                    <div className="w-8 h-8 rounded-lg bg-yellow-500/20 border border-yellow-500/30 flex items-center justify-center">
                                        <svg width="14" height="14" fill="none" stroke="#eab308" strokeWidth="2" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" /><path d="M9 9h6M9 12h6M9 15h4" /></svg>
                                    </div>
                                    <span className="text-base font-bold text-white">Data Engineer Academy</span>
                                </div>
                                <div className="mx-5 mb-6 rounded-2xl overflow-hidden bg-gradient-to-br from-[#0d1117] to-[#1a1f2e] border border-white/10 p-8 text-center">
                                    ...
                                    <p className="text-base text-white/50 mb-7 max-w-md mx-auto leading-relaxed">
                                        Unlock The Skills To Excel In Data Engineering With Our Comprehensive
                                    ...
                                    <div className="mx-auto rounded-2xl overflow-hidden bg-gradient-to-br from-[#1a1a1a] to-[#0b0b0b] border border-white/10 max-w-[240px] p-5 flex items-center gap-4">
                                        <div className="h-14 w-14 rounded-xl bg-yellow-500/20 border border-yellow-500/30 flex items-center justify-center">
                                            <span className="text-2xl font-black text-yellow-400">D</span>
                                        </div>
                                        <span className="text-xl font-extrabold text-white">DE Academy</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl border border-white/10 bg-[#1a1a1a] p-5 mb-5 flex items-center gap-5">
                            <div className="h-16 w-16 rounded-2xl bg-pink-500/20 border border-pink-400/20 flex items-center justify-center text-2xl font-black text-pink-400 flex-shrink-0">P</div>
                            <div>
                                <p className="font-bold text-white text-base">Pop Mart Labubu Wonderland — <span className="text-white/60 font-semibold">$15/month</span></p>
                                <p className="text-sm text-white/50 mt-1 leading-relaxed">Exclusive collector&apos;s community with early access drops and trading channels.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="how-it-works" className="scroll-mt-24 mb-14">
                        <h2 className="text-3xl font-extrabold text-white mb-7">How it works</h2>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={s.n} className="flex items-start gap-6 rounded-2xl border border-white/10 bg-[#1a1a1a] px-7 py-5">
                                    <span className="text-3xl font-black text-white/15 flex-shrink-0 leading-none mt-1">{s.n}</span>
                                    <div>
                                        <p className="font-bold text-white text-base">{s.title}</p>
                                        <p className="text-sm text-white/50 mt-1 leading-relaxed">{s.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div id="get-started" className="scroll-mt-24 mb-14">
                        <h2 className="text-3xl font-extrabold text-white mb-7">Getting started</h2>
                        ...
                        <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-[#1a1a2e] to-[#0f0f1a] p-10 text-center">
                            <p className="text-2xl font-bold text-white mb-3">Ready to start your business?</p>
                            <p className="text-base text-white/50 mb-7">Join thousands of creators already earning on Whop.</p>
                    ...
                    <div className="mt-10 rounded-2xl border border-white/10 bg-[#1a1a1a] p-7 flex items-start gap-5">
                        <div className="h-16 w-16 rounded-full bg-gradient-to-br from-orange-400 to-red-500 flex items-center justify-center text-2xl font-black text-white flex-shrink-0">E</div>
                        <div>
                            <p className="font-bold text-white text-lg">East</p>
                            <p className="text-sm text-white/50 mt-1.5 leading-relaxed">Creator educator and clipping expert. Helping the next generation of digital entrepreneurs build sustainable income streams.</p>
                        </div>
                    </div>

                    <div className="mt-12 flex justify-center">
                        <button className="text-sm text-white/30 hover:text-white/60 transition-colors">Report this content</button>
                    </div>
                </main>
            </div>
                ...
                <div className="px-4 py-2.5 flex items-center gap-2 overflow-x-auto no-scrollbar">
                    {sections.map((s) => (
                        <button
                            key={s.id}
                            onClick={() => scrollTo(s.id)}
                            className={`flex-shrink-0 rounded-lg px-3.5 py-2 text-sm font-medium transition-colors ${activeSection === s.id ? "bg-white text-black" : "bg-white/10 text-white/60"
                                }`}
                        >
                            {s.label}
                        </button>
