...
export default function CampaignCard({ campaign = campaignData[0] }: CampaignCardProps) {
  return (
    <div className="bg-[linear-gradient(90deg, #00000005, #00000005)] border-[#f87f141f] border rounded-2xl shadow-sm border overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
      <div className="p-5 flex flex-col gap-6 h-full">
            ...
            <div className="flex flex-col gap-2 items-end justify-end flex-1">
              <div className="flex gap-1 items-center justify-end flex-wrap">
                {campaign.categories.map((category, index) => (
                  <div key={index} className="inline-flex items-center justify-center px-2 py-1 rounded-full border border-gray-200 bg-gray-50">
        ...
        {/* Stats Section */}
        <div className="flex items-start justify-between w-full pt-2 border-t border-gray-100">
